...
void ConnectionImpl::ClientStreamImpl::encodeHeaders(const RequestHeaderMap& headers, bool end_stream) {
...
void ConnectionImpl::ServerStreamImpl::encodeHeaders(const ResponseHeaderMap& headers, bool end_stream) {
